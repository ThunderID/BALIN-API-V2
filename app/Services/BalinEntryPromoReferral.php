...
class BalinEntryPromoReferral implements EntryUplineInterface 
{
	protected $customer;
	protected $errors;
	...
	public function save()
	{
		...
		//1. Validate 
		$this->pre->validatepromoreferral($this->customer); 
		...
		$this->pro->storebonusesvoucher($customer, $this->pre->referral); 

		//5. requce upline quota
		$this->pro->storequotavoucher($this->pre->referral, $customer); 
