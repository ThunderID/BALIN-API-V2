...
class BalinResetPassword implements ForgotPasswordInterface 
{
	protected $customer;
	protected $errors;
	...
	public function save()
	{
		...
		//1. Validate 
		$this->pre->validateresetpassword($this->customer); 
		...
		/** PROCESS */
		$this->pre->customer->reset_password_link 	= $this->pre->getresetpassword($this->pre->customer);
		...
		$this->post->sendresetpasswordmail($this->pro->customer);

		//4 Return customer Model Object
